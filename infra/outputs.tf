...
output "swa_default_hostname" { value = azurerm_static_web_app.swa.default_host_name }
output "github_client_id"     { value = azuread_service_principal.gha.application_id }
