variable "project"               { type = string, default = "lc-swa" }
...
variable "containerapp_env_name" { type = string, default = "lc-swa-env" }
variable "containerapp_name"     { type = string, default = "lc-swa-api" }
variable "swa_name"              { type = string, default = "lc-swa-frontend" }
